...
\section{Motivation}
\label{sec:org35a95c8}
\begin{frame}[label={sec:orgb9c9ff7}]{Noise in Quantum Computer}
\begin{itemize}
...
\label{sec:orgf7828b3}

\begin{frame}[label={sec:org339f94b}]{Topological Invariant}
\begin{center}
...
\begin{frame}[label={sec:orgfe83453}]{Topological Degeneracy}
\begin{itemize}
...
\label{sec:org787ec59}
\begin{frame}[label={sec:org222afca}]{Physics and Computation}
\begin{itemize}
